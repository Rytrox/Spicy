...
public class NBTItemStackBuilder extends ItemStackBuilder {
    ...
    @NotNull
    public NBTItemStackBuilder withNBTData(@NotNull NBTTagCompound compound) {
        try {
            net.minecraft.server.v1_8_R3.ItemStack handle = (net.minecraft.server.v1_8_R3.ItemStack)
            ...
            NBTTagCompound merged = handle.getTag();
            merged.a(compound);
